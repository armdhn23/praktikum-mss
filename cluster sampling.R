  ...
  rata_rata50 <- sigma_rata_50/50
  
  ##hist
  hist(c(rata_rata10, rata_rata20, rata_rata30, rata_rata40, rata_rata50), main = "Histogram", xlab="Rata-rata")
  #### proporsi
  set.seed(10)
